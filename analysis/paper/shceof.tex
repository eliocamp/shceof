...
For cEOFs, it can be any real number between 0 and \(2\pi\) \citep{horel1984}, corresponding to rotations in the complex plane.
...
This change in phase is observed in ozone anomalies forced by planetary waves that reach the stratosphere \citep{hartmann1979, wirth1993, smith1995}.
...
Second, on a previous paper \citep{campitelli2022} we showed that the strong relationship between the SAM and temperature anomalies around the Antarctic Peninsula is mainly due to the asymmetric part of the SAM.
