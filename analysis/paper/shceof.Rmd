...
We restrict this work to the September-October-November (SON) trimester because during this season both the tropical teleconnections over South America [@cazes-boezio2003] and the SH stratosphere-troposphere interactions [@lim2018] are at their maximum amplitude. 
...
Therefore, we chose the phase of cEOF1 so that the time series corresponding to the 0º cEOF1 has the maximum correlation with the zonal wave 1 of TOC between `r knitr::combine_words(LatLabel(o3wave_lats))`.
