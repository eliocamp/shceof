...
equation <- latex2exp::TeX(paste0("$\\mathrm{Precipitation} = ", 
                                  signif(coef(model)[1], 2), "\\frac{mm}{day} \\sin{(\\mathrm{phase})} + ", 
                                  signif(coef(model)[2], 2), "\\frac{mm}{day} \\cos{(\\mathrm{phase})}$"), output = "text")
