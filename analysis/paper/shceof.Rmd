...
Therefore, although the location of tropical SST anomalies seem to have an effect in defining the phase of the cEOF2, the relationship between the magnitude of cEOF2 and ONI remains uncertain.
...
Secondly, because of how these components are constructed, they are not forced to be orthogonal to each other as in the standard EOF methodology. 
This allows us to show for example, that Imaginary cEOF2, that resembles PSA1 variability, is closely related to the SAM in the troposphere. 
Moreover, the high correlation of this component to the zonally asymmetric portion of the SAM allow to speculate that the A-SAM might actually be a statistical contamination of the PSA mode.
...
The phase of the cEOF2 is related to the variability of ENSO, but its magnitude appears not to be, except for the three strongest ENSO events in the period which coincide with the three strongest cEOF2 years.
