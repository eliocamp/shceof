...
(ref:pp-america-cap) Regression of SON mean precipitation anomalies in South America (mm per day, shaded) and (column a) cEOF1 the (row 1) Imaginary and (column 1) Real phase. For the 1979 -- 2018 \textcolor{red}{¿Cambiaste el año o es un typo?} period.
Areas marked with dots have p-values smaller than 0.05 adjusted for False Detection Rate.
