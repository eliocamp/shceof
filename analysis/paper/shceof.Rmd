...
Zonal asymmetries of extratropical circulation in the Southern Hemisphere strongly modulate weather systems and regional cli8 mate through latitudinal transport of heat, humidity, and momentum [@trenberth1980].
...
@vanloon1972;@trenberth1980;\textcolor{red}{Agregar alguna referencia más actual}].
...
The Pacific South American patterns (PSA1 and PSA2) were calculated as the third and fourth leading EOF of seasonal mean for 500 hPa geopotential height with all seasons together \textcolor{red}{No me quedo claro lo de "all seasons together"} following @mo2001.

Linear trends were computed by Ordinary Least Squares and the 95% confidence interval was computed assuming a t-distribution with the appropriate residual degrees of freedom \textcolor{red}{Referencia?}.
...
\textcolor{red}{Esto está repetido con lo de arriba o querías referirte a otra cosa}
...
For instance, Figure \@ref(fig:eof-naive) shows the leading 4 EOFs of SON geopotential height zonal anomalies at 50 hPa \textcolor{red}{Creo que no aclaras ni acá, ni para los complejos, cuál sería el dominio para el cuál estás calculando el EOF) La barra de colores quedaría mejor si le agregas un contorno que la encierre.}.
...
The cEOF methodology is applied to SON geopotential height zonal anomalies at 50 and 200 hPa, representing a stratsopheric and upper troposhperic level respectively.
