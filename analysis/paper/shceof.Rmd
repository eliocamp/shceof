...
In `r scales::percent(imaginary)` of seasons cEOF2 has a phase similar to either the negative or positive Imaginary phase.
...
This phase preferences is sin agreement with @irving2016, who found a bimodal distribution to PSA-like variability (compare our Figure \@ref(fig:phase-histogram) with their Figure 6).
